import { Component, OnInit, TemplateRef, ViewChild, KeyValueDiffers } from '@angular/core';
...
export class AddRemoveStockComponent implements OnInit {
  ...
  addStock(){
    if(this.newstockcount>0){
      this.isLoading$ = true;
      this.itemService.postRefillItem(this.itemSettings,this.newstockcount,undefined,undefined,localStorage.getItem('email'),localStorage.getItem('password')).subscribe(
        result => {
          this.isLoading$ = false;
          setTimeout(()=>{
          ...
          this.secondmodalbody = "Updating Stock Failed. Please try again.";
          this.openSecondModal();
        }
      )
    }
  ...
  removeStock(){
    if(this.newstockcount>0){
      this.isLoading$ = true;
      this.itemService.postRemoveItem(this.itemSettings,this.newstockcount,undefined,undefined,localStorage.getItem('email'),localStorage.getItem('password')).subscribe(
        result => {
          this.isLoading$ = false;
          setTimeout(()=>{
            this.closeSecondModal();
  ...
  addQuantity(){
    if(this.newquantity>0 && this.newunits!=='choose'){
      this.isLoading$ = true;
      this.itemService.postRefillItem(this.itemSettings,undefined,this.newquantity,this.newunits,localStorage.getItem('email'),localStorage.getItem('password')).subscribe(
        result => {
          this.isLoading$ = false; 
          setTimeout(()=>{
            this.closeSecondModal();
          ...
          this.secondmodalbody = "Updating Quantity Failed. Please try again.";
          this.openSecondModal();
        }
      )}
      else{
        ...
        this.secondmodalbody = "Please make sure you have mentioned the right quantity.";
        this.openSecondModal();
      }
  }
  ...
  removeQuantity(){
    ...
    if(this.newquantity>0 && this.newunits!=='choose'){
      this.isLoading$ = true;
      this.itemService.postRemoveItem(this.itemSettings,undefined,this.newquantity,this.newunits,localStorage.getItem('email'),localStorage.getItem('password')).subscribe(
        result => {
          this.isLoading$ = false;
          setTimeout(()=>{
            this.closeSecondModal();
